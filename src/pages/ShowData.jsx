                ...
                allData.map((val, index) => {
                  return (
                    <tr key={val.id}>
                      ...
                      <td>{val.message}</td>
                      <td>
                        <button className="btn btn-danger btn-sm m-2" onClick={() => deleteData(val.id)}>Delete</button>
                        <button className="btn btn-success btn-sm " onClick={() => EditData(val)}>Edit </button>
                      </td>
                    </tr>
                  )
                })
